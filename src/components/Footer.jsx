...
function Footer() {
  return (
    <footer className="roboto-condensed-400">
      <div className="contactoContainer">
        <p className="contactoText roboto-condensed-600">Contacto</p>
        ...
        <div className="instagram">
          ...
          <a href="https://www.instagram.com/artsdelish/">@ArtsDelish</a>
        </div>
      </div>
      <div className="ubicacionContainer roboto-condensed-400">
        <div className="ubicacion">
          <SpanIcon iconName="pin_drop" />
          <p className="roboto-condensed-600"> Ubicacion</p>
        </div>
        <iframe
